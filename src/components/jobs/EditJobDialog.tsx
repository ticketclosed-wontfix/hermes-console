...
import { updateJob, type Job } from '@/lib/api'
    ...
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50" onClick={onClose}>
      ...
      >
        <div className="flex items-center justify-between px-5 py-4 border-b border-outline-variant/15">
          <h2 className="font-headline font-bold text-sm text-on-surface">Edit Job</h2>
        ...
        <div className="px-5 py-4 space-y-3">
          ...
          <Field label="Schedule" value={schedule} onChange={setSchedule} placeholder="0 9 * * *" />
          <div>
          ...
          <Field label="Skills" value={skills} onChange={setSkills} placeholder="skill1, skill2" />
